const clientId = "588b40f58a144bc7a6037c84ee23d6bf";
...
function populateUI(profile) {
    ...
    if (profile.images[0]) {
        ...
        document.getElementById("imgUrl").appendChild(profileImage);
    }
    ...
    document.getElementById("imgUrl").innerHTML = `
        <img src="${profile.images[0].url}" alt="${profile.display_name}" class="rounded-circle" style="max-width: 200px;"/>`
...
window.onSpotifyIframeApiReady = (IFrameAPI) => {
    ...
    const options = {
        width: '100%',
        height: '160',
        uri: "https://open.spotify.com/track/48lxT5qJF0yYyf2z4wB4xW"
